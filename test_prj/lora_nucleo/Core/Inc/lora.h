...
#define    LORA_PORT                                            huart4
#define    LORA_TX_COMPL                                    0x00000000U
#define    LORA_PIN_M0_PORT                         M0_GPIO_Port
#define    LORA_PIN_M1_PORT                         M0_GPIO_Port
#define    LORA_M0_PORT                         M0_GPIO_Port
#define    LORA_M1_PORT                         M0_GPIO_Port
#define    LORA_PIN_AUX_PORT                         AUX_GPIO_Port
